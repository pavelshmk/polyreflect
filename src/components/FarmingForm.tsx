...
import { MAX_UINT256, STAKING_ADDRESS, TOKEN_ADDRESS } from "../utils/const";
import { toBNJS } from "../utils/utilities";
import clsx from "clsx";
import classNames from "classnames";

const FarmingForm = observer(() => {
            ...
            <form className="deposit-form" onSubmit={onSubmit}>
                <div className="deposit-form__wrap">
                    <div className="exchange-info">
                            ...
                            <div className="exchange-info__row">
                                <div className="exchange-info__col">
                                    <p className="exchange-info__count">
                                        {staked?.toFixed(6).replace(/\.?0+$/, '')}{/*<span className="exchange-info__text">≈ $754.00</span>*/}
                                    </p>
                                    <span className="exchange-info__text">PRF-MATIC Stacked</span>
                                </div>
                                <div className="exchange-info__col">
                                    <span className="exchange-info__count">{totalInPool?.toFixed(6).replace(/\.?0+$/, '')}</span>
                                    <span className="exchange-info__text">Total PRF-MATIC in pool</span>
                                </div>
                            </div>
                            <div className="exchange-info__row">
                                <div className="exchange-info__col">
                        ...
                        <div className="exchange-info__icon exchange-info__icon_pair">
                            <img src={require('../images/icon-curr.svg')} alt=""/>
                            <img src={require('../images/icon-curr-2.svg')} alt=""/>
                        </div>
                    </div>
                    <div className="deposit-form__row">
                        <div className="deposit-form__col">
                            <div className="deposit-form__icon deposit-form__icon_pair">
                                <img src={require('../images/icon-curr.svg')} alt=""/>
                                <img src={require('../images/icon-curr-2.svg')} alt=""/>
                            </div>
                            <h6 className="deposit-form__title">PRF-MATIC</h6>
                    ...
                    <p className="deposit-form__text">Ends in 27 days 5 hours 23 minutes</p>
                    <div className="deposit-form__btns">
                        <a href={`https://quickswap.exchange/#/add/ETH/${TOKEN_ADDRESS}`} target='_blank' className="btn secondary" type="button">Add Liquidity</a>
                        {
                            buttonError ? (
